# BitNinja SonarQube chart

* based on https://github.com/Oteemo/charts/tree/master/charts/sonarqube
* default values changed to fit BitNinja environment
* nodeSelector format is "sel1=val1,sel2=val2"
